...
func main() {
	...
	http.HandleFunc("/auth/login/discord", func(w http.ResponseWriter, r *http.Request) {
	...
	http.HandleFunc("/auth/callback/discord", func(w http.ResponseWriter, r *http.Request) {
